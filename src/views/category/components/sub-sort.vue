<template>
  <div class="sub-sort">
    ...
    <div class="check">
      <xtx-checkbox @change="changCheck" v-model="sortParams.inventory"
        >仅显示有货商品</xtx-checkbox
      >
      <xtx-checkbox @change="changCheck" v-model="sortParams.onlyDiscount"
...
export default {
  ...
  setup(props, { emit }) {
    ...
    return { sortParams, changeSort, changCheck };
  },
};
</script>
